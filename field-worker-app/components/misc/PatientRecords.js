        ...
        <View style={styles.header}>
          <View style={styles.column}>
            <View style={styles.addressContainer}>
              <Text style={styles.name}>Aakash Bhardwaj</Text>
          ...
          <View style={styles.column3}>
            <TouchableOpacity style={styles.viewRecordsButton} onPress={handleViewRecords}>
              <Text style={styles.viewRecordsButtonText}>View Patient Records</Text>
            </TouchableOpacity>
          </View>
        </View>
        <View style={styles.header}>
