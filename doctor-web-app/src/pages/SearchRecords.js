...
function SearchRecords() {
  ...
  useEffect(() => {
    const fetchSearchByDiesease = async () => {
      try {
        const headers = { Authorization: `Bearer ${token}` };
        const response = await getRequest(`/doctor/searchbydisease/${dieseaseList}`, headers);
